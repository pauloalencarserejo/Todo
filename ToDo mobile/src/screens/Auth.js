...
import { server, showError, showSuccess, ShowSuccess } from '../common'
...
export default class Auth extends React.Component {
    ...
    render() {
        //expressão para validar email usando regex
        const validEmail = /\S+@\S+\.\S+/
        const validations = []
        validations.push(this.state.email && validEmail.test(this.state.email))
